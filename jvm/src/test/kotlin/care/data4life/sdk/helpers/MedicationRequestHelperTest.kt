...
class MedicationRequestHelperTest {
    ...
    fun buildWith_shouldReturnMedRequest_whenAllArgsProvided() {
        ...
        // When
        val medRequest =
            MedicationRequestHelper.buildWith(patient, medication!!, Arrays.asList<Dosage>(dosage), NOTE, REASON)
    ...
    fun builtWith_shouldThrow_whenPatientNotProvided() {
        try {
            MedicationRequestHelper.buildWith(null, medication!!, Arrays.asList<Dosage>(dosage), NOTE, REASON)
    ...
    fun builtWith_shouldThrow_whenMedicationNotProvided() {
        try {
            MedicationRequestHelper.buildWith(patient, null, Arrays.asList<Dosage>(dosage), NOTE, REASON)
            fail("Exception expected")
        } catch (e: IllegalArgumentException) {
    ...
    fun builtWith_shouldThrow_whenDosageNotProvided() {
        try {
            MedicationRequestHelper.buildWith(patient, medication, null, NOTE, REASON)
            fail("Exception expected")
        } catch (e: IllegalArgumentException) {
    ...
    fun note_shouldBeNull_whenNotProvided() {
        // When
        val medRequest =
            MedicationRequestHelper.buildWith(patient, medication!!, Arrays.asList<Dosage>(dosage), null, REASON)
    ...
    fun reason_shouldBeNull_whenNotProvided() {
        // When
        val medRequest =
            MedicationRequestHelper.buildWith(patient, medication!!, Arrays.asList<Dosage>(dosage), NOTE, null)
    ...
    private fun buildMedRequest(): MedicationRequest {
        return MedicationRequestHelper.buildWith(patient, medication!!, Arrays.asList<Dosage>(dosage), NOTE, REASON)
    }
    ...
    fun getMedication_shouldReturnMedication() {
        // Given
        val medRequest =
            MedicationRequestHelper.buildWith(patient, this.medication!!, Arrays.asList<Dosage>(dosage), NOTE, REASON)
