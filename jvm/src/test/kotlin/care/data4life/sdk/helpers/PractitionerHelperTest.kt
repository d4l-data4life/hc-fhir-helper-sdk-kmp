...
class PractitionerHelperTest {
    ...
    fun buildWith_shouldReturnPractitioner_whenTextGiven() {
        // When
        val practitioner = PractitionerBuilder.buildWith(TEXT)
    ...
    fun buildWith_shouldReturnPractitioner_whenNameGiven() {
        // When
        val practitioner = PractitionerBuilder.buildWith(NAME, SURNAME)
    ...
    fun builtWith_shouldThrow_whenNameNotProvided() {
        try {
            PractitionerBuilder.buildWith("", SURNAME)
            fail("Exception expected")
        } catch (e: IllegalArgumentException) {
    ...
    fun builtWith_shouldThrow_whenSurnameNotProvided() {
        try {
            PractitionerBuilder.buildWith(NAME, "")
            fail("Exception expected")
        } catch (e: IllegalArgumentException) {
    ...
    fun setAdditionalIds_shouldSetIds() {
        // given
        val p = Practitioner()
        val newIds = Arrays.asList(ADDITIONAL_ID, ADDITIONAL_ID)
