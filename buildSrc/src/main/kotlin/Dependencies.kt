...
object Dependencies {
    ...
    object Test {
        ...
        const val mockkCommon = "io.mockk:mockk-common:${Versions.testMockk}"
        const val mockkAndroid = "io.mockk:mockk-android:${Versions.testMockk}"
        const val mockkJvm = "io.mockk:mockk:${Versions.testMockk}"
