...
== https://github.com/d4l-data4life/hc-fhir-helper-sdk-kmp/compare/v1.7.2...master[Unreleased]
...
== https://github.com/d4l-data4life/hc-fhir-helper-sdk-kmp/compare/v1.7.1...v1.7.2[1.7.2]

=== Bumped

* Re-release of 1.7.1 because of build issues
