...
public class FileHelper {
    ...
    public static String loadString(String fileName) throws IOException {
        InputStream inputStream = care.data4life.sdk.test.util.FileHelper.class.getClassLoader().getResourceAsStream(fileName);
    ...
    public static List<String> loadFileList(String path) throws URISyntaxException {
        URL dirUrl = care.data4life.sdk.test.util.FileHelper.class.getClassLoader().getResource(path);
